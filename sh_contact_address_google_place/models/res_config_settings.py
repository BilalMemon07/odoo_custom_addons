...
class ResCompany(models.Model):
    ...
    sh_is_display_street_reverable = fields.Boolean(
        string="Is the street information displayed in reverse?"
    )
...
class ResConfigSettings(models.TransientModel):
    ...
    sh_google_api_key = fields.Char(
        related="company_id.sh_google_api_key", string="Key", readonly=False
    )
    ...
    sh_is_display_street_reverable = fields.Boolean(
        string="Is the street information displayed in reverse?",
        related="company_id.sh_is_display_street_reverable",
        readonly=False,
    )
