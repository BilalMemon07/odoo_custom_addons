...
""",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'ks_dashboard_ninja/static/libs/css/gridstack.min.css',
            'ks_dashboard_ninja/static/libs/css/awesomplete.css',
            ...
            'ks_dashboard_ninja/static/libs/js/gridstack-h5.js',
            'ks_dashboard_ninja/static/src/js/ks_dashboard_ninja_new.js',
            'ks_dashboard_ninja/static/src/js/ks_global_functions.js',
            'ks_dashboard_ninja/static/libs/js/index.js',
            'ks_dashboard_ninja/static/libs/js/pdfmake.min.js',
            'ks_dashboard_ninja/static/libs/js/percent.js',
            'ks_dashboard_ninja/static/libs/js/pdf.min.js',
            'ks_dashboard_ninja/static/libs/js/print.min.js',
            'ks_dashboard_ninja/static/libs/js/Dataviz.js',
            'ks_dashboard_ninja/static/libs/js/Material.js',
            'ks_dashboard_ninja/static/libs/js/Moonrise.js',
            'ks_dashboard_ninja/static/libs/js/exporting.js',
            'ks_dashboard_ninja/static/libs/js/percent.js',
            'ks_dashboard_ninja/static/libs/js/Animated.js',
            'ks_dashboard_ninja/static/libs/js/worldLow.js',
            'ks_dashboard_ninja/static/libs/js/map.js',
            'ks_dashboard_ninja/static/libs/js/awesomplete.js',
            'ks_dashboard_ninja/static/src/js/ks_dashboard_ninja_new.js',
            'ks_dashboard_ninja/static/src/js/ks_global_functions.js',
            'ks_dashboard_ninja/static/libs/js/xy.js',
            'ks_dashboard_ninja/static/libs/js/radar.js',
